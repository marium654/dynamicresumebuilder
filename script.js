...
const form = document.getElementById("resumeform"); // Corrected ID
const resumePage = document.getElementById("resumePage"); // Changed to HTMLDivElement
...
form.addEventListener("submit", (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const education = document.getElementById("education").value; // Changed to match ID
    const workExperience = document.getElementById("details").value; // Changed to match ID
...
function updateFormFromResume() {
    ...
    document.getElementById("details").value = resumeWorkExperience.textContent || ``;
